...
This code is for the CNN implementation for Sinc distribution.
"""
...
class CNN2d(nn.Module):
    def __init__(self, width):
        ...
        # forward layers,
        self.conv0 = nn.Conv2d(self.width, 64, 3, stride=2)
        ...
        self.conv5 = nn.ConvTranspose2d(16, 32, 3, stride=2)
        self.conv6 = nn.ConvTranspose2d(32, 64, 3)
        self.conv7 = nn.ConvTranspose2d(64, self.width, 3, stride=2)
