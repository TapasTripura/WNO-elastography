...
"""
# torch.save(model, 'model/data_inclusion_500samples')
# scipy.io.savemat('pred/data_inclusion_500samples.mat', mdict={'pred': pred.cpu().numpy()})

# scipy.io.savemat('epoch_loss/epoch_loss_inclusion_500samples.mat', mdict={'epoch_loss': epoch_loss.cpu().numpy()})
# scipy.io.savemat('epoch_prediction/epoch_pred_inclusion_500samples.mat', mdict={'epoch_pred': epoch_pred.cpu().numpy()})
