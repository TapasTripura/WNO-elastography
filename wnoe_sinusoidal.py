...
"""
# torch.save(model, 'model/data_wavy_500samples')
# scipy.io.savemat('pred/data_wavy_500samples.mat', mdict={'pred': pred.cpu().numpy()})

# scipy.io.savemat('epoch_loss/epoch_loss_wavy_500samples.mat', mdict={'epoch_loss': epoch_loss.cpu().numpy()})
# scipy.io.savemat('epoch_prediction/epoch_pred_wavy_500samples.mat', mdict={'epoch_pred': epoch_pred.cpu().numpy()})
