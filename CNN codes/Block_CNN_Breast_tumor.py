...
This code is for the BLOCK CNN implementation for Tumor dataset.
"""
...
class CNN2d(nn.Module):
    def __init__(self, width):
        ...
        # forward layers,
        self.conv0 = nn.Conv2d(self.width, 32, 3, stride=1)
        self.conv1 = nn.Conv2d(32, 16, 3)
        self.conv2 = nn.Conv2d(16, 8, 3, stride=1)
        self.conv3 = nn.Conv2d(8, 4, 3)
        
        # transpose layers,
        self.conv4 = nn.ConvTranspose2d(4, 8, 3)
        self.conv5 = nn.ConvTranspose2d(8, 16, 3, stride=1)
        self.conv6 = nn.ConvTranspose2d(16, 32, 3)
        self.conv7 = nn.ConvTranspose2d(32, self.width, 3, stride=1)
